...
const ALL_GAMES = [
  ...
  { id: '100-player-chess-option-2', title: '100 Player Chess Option 2', iconUrl: '/icons/ai-test-100-player/100-player-chess-option-2.png', gameUrl: 'https://100playerchess.com' },
  { id: '100-player-chess-option-3', title: '100 Player Chess Option 3', iconUrl: '/icons/ai-test-100-player/100-player-chess-option-3.png', gameUrl: 'https://100playerchess.com' },
  { id: '100-player-chess-option-4', title: '100 Player Chess Option 4', iconUrl: '/icons/ai-test-100-player/100-player-chess-option-4.png', gameUrl: 'https://100playerchess.com' },
